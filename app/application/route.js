...
export default class ApplicationRoute extends Route {
  ...
  async beforeModel() {
    ...
    const post1 = { title: 'Tytuł testowy 1', body: 'Zawartość testowa 1' };
    const post2 = { title: 'Tytuł testowy 2', body: 'Zawartość testowa 2' };
    const post3 = { title: 'Tytuł testowy 3', body: 'Zawartość testowa 3' };
